...
{
 "use strict";
 var Global,Counter,Client,SC$1,WebSharper,UI,Var,Obj,Operators,Unchecked,System,Guid,List,T,Message,Arrays,Templating,Runtime,Server,Handler,View,Runtime$1,TemplateInstance,ConcreteVar,Snap,Collections,Dictionary,HashSet,Client$1,Seq,Abbrev,Fresh,JavaScript,Pervasives,DictionaryUtil,Enumerator,Object,T$1,Doc,Numeric,JSModule,DomUtility,EventTarget,Node,SC$2,Slice,Docs,Strings,CharacterData,Elt,Mailbox,DocElemNode,HashSetUtil,Queue,SC$3,Attrs,CheckedInput,AttrModule,AttrProxy,Array,Updates,Client$2,Docs$1,RunState,NodeSet,An,Attrs$1,Dyn,String,Concurrency,Anims,AppendList,Settings,Char,DynamicAttrNode,SC$4,AsyncBody,SC$5,CT,SC$6,HashSet$1,SC$7,Scheduler,CancellationTokenSource,Easing,OperationCanceledException,SC$8,Lazy,DomNodes,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$2,Math,console,$,Date;
 Global=window;
 Counter=Global.Counter=Global.Counter||{};
 Client=Counter.Client=Counter.Client||{};
 SC$1=Global.StartupCode$Counter$Client=Global.StartupCode$Counter$Client||{};
 ...
 {
  return msg.$==1?model-1:model+1;
 };
 SC$1.$cctor=function()
 {
  var vmodel,p,p$1,t,$1,c,ti,p$2;
  SC$1.$cctor=Global.ignore;
  function handle(msg)
  {
   vmodel.Set(Client.update(msg,vmodel.Get()));
  }
  function f(a)
  {
   handle(Message.Increment);
  }
  function f$1(a)
  {
   handle(Message.Decrement);
  }
  SC$1.init=0;
  SC$1.view=(vmodel=Var.Create$1(Client.init()),(p=(p$1=(t=($1=[null],[$1,(c=Guid.NewGuid(),Global.String(c)),new T({
   $:1,
   $0:{
    $:5,
    $0:"onincrement",
   ...
   $0:{
    $:2,
    $0:"counter",
    $1:View.Map(Global.String,vmodel.get_View())
   },
   $1:p$1[2]
  })]),p$2=Handler.CompleteHoles(p[1],p[2],[]),p[0][0]=new TemplateInstance.New(p$2[1],Runtime$1.RunTemplate(p$2[0])),function(model)
  {
   vmodel.Set(model);
  }));
 };
 ...
 TemplateInstance=Server.TemplateInstance=Runtime$2.Class({},Obj,TemplateInstance);
